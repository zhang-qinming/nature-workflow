...
library(data.table)
MCH_GWAS<-fread("data/GWAS/30050_irnt.tsv.gz", header=T, data.table=F)
...
write.table(res_summary, paste0("program_trans/result/P", P, "_transeQTL_MCH_directionalTest.txt"), row.names=F, sep="\t", quote=F)
