...
KSELECT_FACTORIZE_CPUS="${KSELECT_FACTORIZE_CPUS:-28}"
...
KSELECT_POST_MEM="${KSELECT_POST_MEM:-120G}"
KSELECT_POST_CPUS="${KSELECT_POST_CPUS:-28}"
KSELECT_POST_PARTITION="${KSELECT_POST_PARTITION:-cu,privority,batch01}"
KSELECT_POST_TIME="${KSELECT_POST_TIME:-2-00:00:00}"

CONSENSUS_MEM="${CONSENSUS_MEM:-120G}"
CONSENSUS_CPUS="${CONSENSUS_CPUS:-28}"
