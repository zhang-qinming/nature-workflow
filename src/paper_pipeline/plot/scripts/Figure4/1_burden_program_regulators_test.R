...
write.table(summary_reg, paste0("data/Perturbseq/trait_association/K562GW/ProgramLevel/regulators_enrichment_K", K, "_", FILE), row.names=F, sep="\t", quote=F)
write.table(summary_pro, paste0("data/Perturbseq/trait_association/K562GW/ProgramLevel/programs_enrichment_K", K, "_", FILE), row.names=F, sep="\t", quote=F)
