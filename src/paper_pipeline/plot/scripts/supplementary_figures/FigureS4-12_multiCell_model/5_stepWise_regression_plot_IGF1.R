...
FILE="Backman_2021_133.per_gene_estimates.tsv"
...
top_list=c("GSE264667_hepg2_raw_singlecell_01_P33", "GSE264667_hepg2_raw_singlecell_01_P18", "GSE264667_hepg2_raw_singlecell_01_P21")
...
write.table(summary_reg, paste0("multiCell_model/conditional/IGF1_regulators_enrichment_top4.txt"), row.names=F, sep="\t", quote=F)
...
data<-read.table(paste0("multiCell_model/conditional/IGF1_regulators_enrichment_top4.txt"), header=T, stringsAsFactor=F)
...
pdf("multiCell_model/conditional/Combined_IGF1_conditionalPlot_forSupplement.pdf", height=13, width=15)
set.seed(50)
