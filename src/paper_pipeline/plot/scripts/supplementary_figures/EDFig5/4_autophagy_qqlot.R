...
autophagy_geneset_path <- if (length(args) >= 5) as.character(args[5]) else "data/geneset/Autophagosome_genes.txt"
...
geneset<-read.table(autophagy_geneset_path, header=F, stringsAsFactor=F)[,1]
