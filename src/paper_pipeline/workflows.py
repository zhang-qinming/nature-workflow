...
WORKFLOW_BUILDERS: dict[str, WorkflowBuilder] = {
    ...
    "perturbseq-cnmf-essential-kselect-prepare": build_perturbseq_cnmf_essential_kselect_prepare_tasks,
    "perturbseq-cnmf-essential-kselect-factorize": build_perturbseq_cnmf_essential_kselect_factorize_tasks,
    "perturbseq-cnmf-essential-kselect-postbase-base": build_perturbseq_cnmf_essential_kselect_postbase_base_tasks,
