...
export SCATTER_TOP_N_LABELS=${SCATTER_TOP_N_LABELS}
export SCATTER_HIGHLIGHT_GENES=${SCATTER_HIGHLIGHT_GENES}
export SCATTER_Y_LIMIT=${SCATTER_Y_LIMIT}
...
echo "Next: bash test/gene_level_scatter/2_submit.sh"
