...
{
    printf 'figure_id\tfigure_kind\tsource_id\ttable_long_path\ttable_program_path\tplot_pdf\tplot_png\tstatus\n'
    for source_id in "${ALL_IDS[@]}"; do
        table_long_path="${TABLES_DIR}/${source_id}_long.tsv"
        table_program_path="${TABLES_DIR}/${source_id}_programs.tsv"
