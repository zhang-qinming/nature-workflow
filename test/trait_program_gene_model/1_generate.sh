...
SBATCH_PARTITION="${SBATCH_PARTITION:-cu,fat,batch01,privority,gpu,A800}"
...
export TPGM_K=${TPGM_K}
export TPGM_PROGRAM_N=${TPGM_PROGRAM_N}
export TPGM_REGULATOR_N=${TPGM_REGULATOR_N}
export TPGM_LOADING_TOP_N=${TPGM_LOADING_TOP_N}
export TPGM_HIT_ABS_GAMMA_THRESHOLD=${TPGM_HIT_ABS_GAMMA_THRESHOLD}
export TPGM_REGULATOR_FDR_THRESHOLD=${TPGM_REGULATOR_FDR_THRESHOLD}
export TPGM_RANDOM_ITERATIONS=${TPGM_RANDOM_ITERATIONS}
export TPGM_PERMUTATION_ITERATIONS=${TPGM_PERMUTATION_ITERATIONS}
export TPGM_MAX_GENES_PER_SIDE=${TPGM_MAX_GENES_PER_SIDE}
export TPGM_RENDER_PLOT=${TPGM_RENDER_PLOT}
export TPGM_PROGRAM_FDR_THRESHOLD=${TPGM_PROGRAM_FDR_THRESHOLD}
export TPGM_REGULATOR_MAX_N=${TPGM_REGULATOR_MAX_N}
export TPGM_POSTERIOR_DIR=${TPGM_POSTERIOR_DIR}
export TPGM_GENE_MAP=${TPGM_GENE_MAP}
export TPGM_SHET_PATH=${TPGM_SHET_PATH}
export TPGM_SPECTRA_PATH=${TPGM_SPECTRA_PATH}
export TPGM_REGULATION_DIR=${TPGM_REGULATION_DIR}
...
echo "Next: bash test/trait_program_gene_model/2_submit.sh"
